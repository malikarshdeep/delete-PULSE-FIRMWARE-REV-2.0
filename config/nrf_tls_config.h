...
#define MBEDTLS_PLATFORM_STD_CALLOC        nrf_calloc /**< Default allocator to use, can be undefined */
...
/* SSL options */
#define MBEDTLS_SSL_MAX_CONTENT_LEN               (1024*6) /**< Maxium fragment length in bytes, determines the size of each of the two internal I/O buffers */
